...
if [[ "$WORKFLOW" == "presubmit" ]]; then
  ...
  export CB_GCS_MONTHLY_RELEASE_PATH=${CB_GCS_MONTHLY_RELEASE_PATH:-$CB_GCS_BUILD_BUCKET/monthly/$CB_VERSION}
  export CB_GCS_BUILD_PATH=${CB_GCS_BUILD_PATH:-$CB_GCS_BUILD_BUCKET/$CB_PIPELINE_TYPE/$CB_VERSION}
  export CB_GCS_FULL_STAGING_PATH=${CB_GCS_FULL_STAGING_PATH:-$CB_GCS_STAGING_BUCKET/$CB_PIPELINE_TYPE/$CB_VERSION}
  export CB_GCS_RELEASE_TOOLS_PATH=${CB_GCS_RELEASE_TOOLS_PATH:-$CB_GCS_BUILD_BUCKET/release-tools/$CB_PIPELINE_TYPE/$CB_VERSION}
