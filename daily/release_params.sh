...
export CB_COMMIT=37a92ed26f7c1c8326e927fa0bd9251cdec15277
export CB_DOCKER_HUB=gcr.io/istio-release
export CB_GCS_BUILD_BUCKET=istio-release-pipeline-data
export CB_GCS_BUILD_PATH=istio-release-pipeline-data/daily-build/master-20181212-23-41
export CB_GCS_FULL_STAGING_PATH=istio-prerelease/daily-build/master-20181212-23-41
export CB_GCS_MONTHLY_RELEASE_PATH=
export CB_GCS_RELEASE_TOOLS_PATH=istio-release-pipeline-data/release-tools/daily-build/master-20181212-23-41
...
export CB_VERSION=master-20181212-23-41
