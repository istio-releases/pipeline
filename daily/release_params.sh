...
export CB_GCS_BUILD_PATH=istio-release-pipeline-data/daily-build/release-1.1-20181213-09-16
export CB_GCS_FULL_STAGING_PATH=istio-prerelease/daily-build/release-1.1-20181213-09-16
export CB_GCS_MONTHLY_RELEASE_PATH=
export CB_GCS_RELEASE_TOOLS_PATH=istio-release-pipeline-data/release-tools/daily-build/release-1.1-20181213-09-16
...
export CB_VERSION=release-1.1-20181213-09-16
