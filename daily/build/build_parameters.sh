...
export CB_COMMIT=3a28edf79f2737d1cae27a8d5cde9926d1bf0997
export CB_DOCKER_HUB=gcr.io/istio-release
export CB_GCS_BUILD_BUCKET=istio-release-pipeline-data
export CB_GCS_BUILD_PATH=istio-release-pipeline-data/daily-build/master-20181212-22-41
export CB_GCS_FULL_STAGING_PATH=istio-prerelease/daily-build/master-20181212-22-41
export CB_GCS_MONTHLY_RELEASE_PATH=
export CB_GCS_RELEASE_TOOLS_PATH=istio-release-pipeline-data/release-tools/daily-build/master-20181212-22-41
...
export CB_VERSION=master-20181212-22-41
