...
export CB_GCS_BUILD_PATH=istio-release-pipeline-data/daily-build/master-20181210-19-12
export CB_GCS_FULL_STAGING_PATH=istio-prerelease/daily-build/master-20181210-19-12
export CB_GCS_MONTHLY_RELEASE_PATH=
export CB_GCS_RELEASE_TOOLS_PATH=istio-release-pipeline-data/release-tools/daily-build/master-20181210-19-12
...
export CB_VERSION=master-20181210-19-12
